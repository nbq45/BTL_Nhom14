                        ...
                        <ul class="nav nav-pills flex-column">
                          <li class="nav-item">
                            ...
                            <div id="section2" > 
                              ...
                              <div class="row">
                                <div class="col-sm-3">
                                  <a href=""><img src="assets/img/bac-xiu.jpg" width="60%" style="margin: 5px;"></a>
                                </div>
                                <div class="col-sm-6">
                                <h1 class="text text-right" >Bạc xỉu</h1>
                                </div>
                                <div class="col-sm-3">
                                    <h1 class="text text-right" style="color: #0288d1;">35,000đ
                              ...
                              <div class="row">
                                <div class="col-sm-3">
                                  <a href=""><img src="assets/img/cafe-den.jpg" width="60%" style="margin: 5px;"></a>
                                </div>
                                <div class="col-sm-6">
                                <h1 class="text text-right">Cà phê đen</h1>
                                </div>
                                <div class="col-sm-3">
                                    <h1 class="text text-right" style="color: #0288d1">28,000đ
                                      <button type="button" class="btn btn-primary" >+</button>
                                    </h1>
                                </div>
                              </div>
                              <div class="row">
                                <div class="col-sm-3">
                                  <a href=""><img src="assets/img/cafe-nau.jpg" width="60%" style="margin: 5px;"></a>
                                </div>
                                <div class="col-sm-6">
                                <h1 class="text text-right">Cà phê nâu</h1>
                                </div>
                                <div class="col-sm-3">
                                    <h1 class="text text-right" style="color: #0288d1">30,000đ
                                      <button type="button" class="btn btn-primary" >+</button>
                                    </h1>
                                </div>
                              </div>
                              <div class="row">
                                <div class="col-sm-3">
                                  <a href=""><img src="assets/img/capuchino.jpg" width="60%" style="margin: 5px;"></a>
                                </div>
                                <div class="col-sm-6">
                                <h1 class="text text-right">Capuchino</h1>
                                </div>
                                <div class="col-sm-3">
                                    <h1 class="text text-right" style="color: #0288d1">40,000đ
                                      <button type="button" class="btn btn-primary" >+</button>
                                    </h1>
                                </div>
                              </div>
                            ...
                            <div id="section3">
                              ...
                              <div class="row">
                                <div class="col-sm-3">
                                  <a href=""><img src="assets/img/tra-dao-cam-sa.jpg" width="60%" style="margin: 5px;"></a>
                                </div>
                                <div class="col-sm-6">
                              ...
                              <div class="row">
                                <div class="col-sm-3">
                                  <a href=""><img src="assets/img/tra-chanh.jpg" width="60%" style="margin: 5px;"></a>
                                </div>
                                <div class="col-sm-6">
                              ...
                              <div class="row">
                                <div class="col-sm-3">
                                  <a href=""><img src="assets/img/hong-tra-sua.jpg" width="60%" style="margin: 5px;"></a>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <div id="section4">
                              ...
                              <div class="row">
                                <div class="col-sm-3">
                                  <a href=""><img src="assets/img/sua-chua-da.jfif" width="60%" style="margin: 5px;"></a>
                                </div>
                                <div class="col-sm-6">
                              ...
                              <div class="row">
                                <div class="col-sm-3">
                                  <a href=""><img src="assets/img/sua-chua-cacao.jpg" width="60%" style="margin: 5px;"></a>
                                </div>
                                <div class="col-sm-6">
                              ...
                              <div class="row">
                                <div class="col-sm-3">
                                  <a href=""><img src="assets/img/sua-chua-cafe.jpg" width="60%" style="margin: 5px;"></a>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <div id="section5">
                              ...
                              <div class="row">
                                <div class="col-sm-3">
                                  <a href=""><img src="assets/img/banh-quy.jpg" width="60%" style="margin: 5px;"></a>
                                </div>
                                <div class="col-sm-6">
                              ...
                              <div class="row">
                                <div class="col-sm-3">
                                  <a href=""><img src="assets/img/banh-quy-socola.jpg" width="60%" style="margin: 5px;"></a>
                                </div>
                                <div class="col-sm-6">
