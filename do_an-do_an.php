    ...
    <div class="container">
      ...
      <div class="content">
        <ul class="product_list">
          <li style="margin-right: 25px; margin-bottom: 25px">
            <a href="">
              <img src="assets/img/Logo-ShopeefoodVN.jpg" alt="" />
              <p
                class="title_product"
                style="font-size: medium; color: black; font-weight: bold"
              >
                Lotteria - Trung Kính - Hà Nội
              </p>
              <p
                class="address_product"
                style="font-size: small; color: darkgray; font-weight: bold"
              >
                299 Trung Kính, Cầu Giấy, Hà Nội
              </p>
              <hr />
              <p class="promotion" style="font-size: medium">
                <i class="bi bi-tag-fill">Mã giảm giá 40k</i>
              </p>
            </a>
          </li>
          <li style="margin-right: 25px; margin-bottom: 25px">
        ...
        <div class="footer_infor">
          ...
          <p>
            ...
            nhanh chóng:
            <a href="#">đồ ăn</a>,<a href="#">đồ uống</a>,<a href="#">đồ chay</a
            >...đến các loại<a href="#">bánh kem</a>,<a href="#">tráng miệng</a
            >,<a href="#">vỉa hè</a>...Mở ứng dụng, Chỉ cần nghĩ tới keyword
          ...
          <p>
            ...
            <a href="#">Quỳnh Anh - ăn vặt online</a>,<a href="#">
              Ăn vặt phố Khâm Thiên</a
            >,<a href="#"> Tipu Snack</a>,... hay dân văn phòng sẽ thật mê các
            chuỗi nhà hàng thức ăn nhanh: <a href="#">Lotteria</a>,<a href="#">
              Umbala Bánh Mì & Xôi</a
            >,<a href="#"> Umbala Bánh Mì & Xôi</a>,<a href="#">
              Umbala Bánh Mì & Xôi</a
            >... hay hẹn hò tại nhà với ẩm thực Á Âu đa dạng:
            <a href="#"> Al Frescos</a>,<a href="#"> Al Frescos</a>,<a
              href="#"
            >
              nhà hàng Fê - Bạch Mai</a
            >,<a href="#"> Isushi Buffet Nhật Bản</a>...
          </p>
          <h2
          ...
          <p>
            ...
            <a href="#"> Rẻ hơn tự nấu</a>,<a href="#"> Sạch như nhà làm </a>,<a
              href="#"
            >
              FreeshipXtra</a
            >... giúp cho bạn dễ dàng cân nhắc theo kinh phí, hay sở thích.
